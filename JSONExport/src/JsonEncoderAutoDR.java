...
public class JsonEncoderAutoDR {
	...
	public void JsonEncode(String IPPath, String OPPath) {
	        try {
				...
				//String ODFundusList = JSONObject.escape((String) jsonObject.get("ODFundusList"));
				//String OSFundusList =JSONObject.escape((String) jsonObject.get("OSFundusList"));
