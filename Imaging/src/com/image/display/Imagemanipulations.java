...
public class Imagemanipulations extends JPanel implements ActionListener
{
	private static final long serialVersionUID = 1L;
	 ...
	 JButton btnReset;
	 JButton btnFlip ;
	 ImagePanel2 objImagePanel;
	public Imagemanipulations() throws IOException
	{
...
public static void main(String[] args) throws IOException 
{
	...
	Imagemanipulations objImageOperation = new Imagemanipulations();
