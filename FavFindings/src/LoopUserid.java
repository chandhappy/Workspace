...
public class LoopUserid {
   ...
   static String[] RegionsFindings = {
	...
	String CreatedAt="2018-10-23T14:58:56.782Z",
			UpdatedAt="2018-10-23T14:58:56.782Z";

	static String ProductId = "visuhealth";;
	
/*	String CreatedAt = "2018-09-21 12:00:58.580",
	UpdatedAt = "2018-09-21 12:00:58.580";*/
	
	static String[] ClinicalFindings = {
	...
	static String[] ObservationAndComments = {
	...
	static String[] RecommendationDetails = {
	...
	public static void main(String[] args) throws Exception {
		...
		for (i = 0; i<CreatedBy.length; i++) {
			for (int j = 0; j < name.length; j++) {
				...
				try {
					String url = "https://visuhealthservices.zeiss.co.in/StudyServiceAPI/api/ClinicalFindings/CreateFaouriteFinding";
					URL obj = new URL(url);
					
					HttpsURLConnection con = (HttpsURLConnection) obj.openConnection();
					String Auth= "Bearer 54cYtt60Hy08ibebWkGRf1iceslJrRaTn-6p-d8MeiOlz_OqpZKXOvzJQVJ2wolvo6yvbgsiRGEjj2kehMQkiDPpF8tzRDqeqq0DkGuRa3tCr-BgTJiHlCBVYUwEHfiONZ_XVflf2TvRaUcjjvRI2LUZjizCBnawMZvHPTGnF6fcBwtNtFhGy1zDrjYj_b2XhXY9093diuv3ngXAMsbcH7thObMARAmYQTBKRmlVX_sWZkocI6HgC66eDudez0U-X6-j8jwy9KzMfBMMWFnkNQrD099mXX70mHgdMKrUGQFxbCZZ2WVhp5A1y4sP_33LPAAkypaDeajn5k8dEQbzSZsfpYId8c7qqcU3pf77YzG79vkgkyRgF_PpFMjcINi_Y9hDagjhn2dK2pBkB8L3BA";
					...
					json.put("ClinicalFindings",ClinicalFindings[j]); 
					json.put("ObservationAndComments",ObservationAndComments[j]);
					json.put("RecommendationDetails",RecommendationDetails[j]);
					JSONObject json1= new JSONObject(RegionsFindings[j]);
					json.put("RegionsFindings",json1);
	...
	// HTTP GET request
		...
		private void sendGet() throws Exception {
			...
			String url = "https://visuhealthservices.zeiss.co.in/StudyServiceAPI/api/AcquisitionCenter/GetSampleTest ";
	...
	// HTTP POST request
		...
		private void sendPost() throws Exception {
			...
			JSONObject json1= new JSONObject(RegionsFindings);
			json.put("RegionsFindings",json1);
			json.put("ProductId", ProductId);
			String urlParameters = json.toString();
			System.out.println(urlParameters);
